...
class D3QNetAgent(AgentWithConverter):
    def __init__(self, 
        ...
        self.d3qn = D3QNet(self.action_size,
        ...
        self.frames = []
        self.next_frames = []
        self.replay_buffer = PrioritizedReplayBuffer(self.buff_size, self.alpha,
    ...
    def learn(self,
        ...
        while (total_steps < num_steps or epoch < num_epochs):
            ...
            while (not self.done):
                ...
                w_batch, ind_batch)= (self.replay_buffer.sample(self.batch_size, 
                                                                total_steps))
